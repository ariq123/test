...
<div class="row align-items-center" style="min-height: 80vh;">
    ...
    <div class="col-md-5 mb-4" data-aos="fade-right">
        @if($movie->Poster != 'N/A')
        <img src="{{ $movie->Poster }}" class="img-fluid rounded shadow-lg mt-5 mt-md-0" style="border: 1px solid rgba(255,255,255,0.2); width: 100%; max-width: 400px; display: block; margin: auto;">
        @else
        <img src="https://via.placeholder.com/400x600?text=No+Poster" class="img-fluid rounded shadow-lg mt-5 mt-md-0">
        @endif
    </div>
    ...
    <div class="col-md-7" data-aos="fade-left">
        ...
        <div class="d-flex align-items-center mb-4 mt-2">
            <img src="{{ asset('img/imdb.png') }}" alt="IMDb" style="height: 3.5em; margin-right: 10px;">

            <span class="text-warning font-weight-bold" style="font-size: 1rem;">
                <i class="fas fa-star"></i> {{ $movie->imdbRating }}
            </span>
            <span class="text-muted mx-3">|</span>
            <span class="badge badge-dark border border-secondary p-2">{{ $movie->Year }}</span>
        ...
        <div class="row mb-4 text-white-50" style="font-size: 0.9rem;">
            <div class="col-md-6 mb-2"><i class="fas fa-film mr-2 text-white"></i> <b>Genre:</b> {{ $movie->Genre }}
            </div>
            <div class="col-md-6 mb-2"><i class="fas fa-user-tie mr-2 text-white"></i> <b>Director:</b>
                {{ $movie->Director }}</div>
            <div class="col-md-12"><i class="fas fa-users mr-2 text-white"></i> <b>Actors:</b> {{ $movie->Actors }}
            </div>
        </div>
